...
export default function AddTaskModa({onSave,taskToUpdate,handelCloseClick}) {
    ...
    const [isAdd, setIsAdd] = useState(Object.is(taskToUpdate, null)) // taskToUpdate null hole is add true hoea jabe
